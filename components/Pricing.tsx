...
const packages = [
    {
        name: "BASIC",
        subtitle: "דף נחיתה יחיד - מושלם להתחלה",
        price: "999",
        features: [
            { name: "עמוד יחיד (One-Page)", included: true },
            { name: "כותרת + אודות + יצירת קשר", included: true },
            { name: "רשימת שירותים טקסטואלית", included: true },
            { name: "עיצוב נקי ומקצועי", included: true },
            { name: "מותאם למובייל", included: true },
            { name: "קטלוג מוצרים עם תמונות", included: false },
            { name: "מערכת ניהול תורים", included: false },
        ],
        highlight: false,
        cta: "מתחילים",
    },
    {
        name: "BUSINESS",
        subtitle: "אתר מלא ומקצועי - התמורה הכי טובה!",
        price: "1,499",
        features: [
            { name: "מספר עמודים מלאים", included: true },
            { name: "קטלוג מוצרים/שירותים עם תמונות", included: true },
            { name: "כל פריט עם תיאור מפורט ומחיר", included: true },
            { name: "גלריית תמונות + סרטונים", included: true },
            { name: "המלצות לקוחות", included: true },
            { name: "עיצוב פרימיום מותאם אישית", included: true },
            { name: "SEO בסיסי", included: true },
            { name: "מערכת ניהול תורים", included: false },
    ...
    {
        name: "PREMIUM",
        subtitle: "הפתרון המושלם לעסקים רציניים",
        price: "2,999",
        features: [
            { name: "כל מה שיש ב-BUSINESS", included: true },
            { name: "מערכת ניהול תורים", included: true },
            { name: "בלוג עם מאמרים", included: true },
            { name: "מערכת ביקורות", included: true },
            { name: "SEO מתקדם", included: true },
                    ...
                    {packages.map((pkg, index) => (
                        ...
                        >
                            ...
                            <div className={`relative h-full rounded-2xl border ${pkg.highlight
                                ...
                                <p className="text-slate-400 mb-6 text-sm">{pkg.subtitle}</p>
